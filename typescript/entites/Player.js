        ...
        if (this.lag <= 0) {
            ...
            if (this.clickThisFrame) {
                ...
                if (Player.selectedWeapon == 0) {
                    ...
                    var bullet = this.game.add.sprite(this.sprite.x + 24 * cosine, this.sprite.y + 24 * sine, "arrow", 0, this.weaponsGroup);
                    bullet.maxHealth = 2;
                    bullet.health = 2;
                    ...
                    this.weapon.animations.play("shoot");
                    var bullet = this.game.add.sprite(this.sprite.x + 24 * cosine, this.sprite.y + 24 * sine, "bullet", 0, this.weaponsGroup);
                    bullet.maxHealth = 2;
                    bullet.health = 2;
                    bullet.anchor.setTo(0.5, 0.5);
